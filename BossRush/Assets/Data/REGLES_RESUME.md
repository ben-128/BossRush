...
| Épreuves (génériques) | 30 | 15 assauts + 15 événements à choix — commun à tous les boss |
...
3. **Deck Épreuve** : mélanger les 30 cartes Épreuve génériques. Placer la pile face cachée.
...
7. **Pioche initiale** : chaque joueur pioche 3 cartes Arsenal (Actions et Objets restent en main).
...
### Subir des dégâts
La carte infligeant les dégâts se place **sous le héros** = blessure. Si total ≥ PV → hors combat.
...
- **PV** : formule adaptée au nombre de joueurs (ex : 8 + 4/joueur).
...
- **PV** / **Dégâts** / **Capacité spéciale** éventuelle.
...
├─────────────────────────────────────────┤
│ 3. CAPACITÉ SPÉCIALE (optionnel, 1x)    │
├─────────────────────────────────────────┤
│ 4. MONSTRES                             │

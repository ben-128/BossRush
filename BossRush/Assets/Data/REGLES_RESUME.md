...
7. **Pioche initiale** : chaque joueur pioche 3 cartes Arsenal.
...
- Posé face visible devant le héros dès la pioche.
- Utilisable **à tout moment** pendant le tour, **en plus** de l'action principale.
...
### 3. En plus (optionnel, à tout moment pendant son tour)
- Utiliser ses Objets sur la table
- Activer sa capacité spéciale (1×/combat)

> **Important** : les Objets posés sur la table et la capacité spéciale sont utilisables **à tout moment pendant le tour du héros**, y compris en réaction à une attaque de boss ou de monstre (étapes 1 et 4). Seules les cartes Action en main nécessitent l'étape 2.

...
6. **Héros** : chaque joueur pioche 1 héros aléatoire.
7. **Pile Chasse** :
...
8. **Pioche initiale** : chaque joueur pioche 3 cartes Chasse (Actions et Objets restent en main).
9. **Échanges libres** entre joueurs avant de commencer.
10. **Choisir** qui commence.
...
### Subir des dégâts et placement des blessures

Quand une carte inflige des dégâts à un héros ou un monstre, glissez-la **sous la cible** en la décalant vers le bas pour que les icônes 🩸 (bas-gauche) restent visibles. Ne superposez pas complètement les blessures — chaque carte doit rester lisible individuellement (nécessaire pour le soin).
...
Le joueur compare les icônes 🩸 empilées à gauche avec les ❤ du héros en bas-droite.
...
Même principe pour un monstre ou un colosse qui reçoit des blessures :
...
─ ─ ─┼──────────────────────────┼─ ─ ─
     ...
     │░ 🩸🩸 ░░░░░░░░░░░░░░░░░░│ ← 2 blessures
─ ─ ─┼──────────────────────────┼─ ─ ─
     │░░ carte attaque spéciale│
     │░ 🩸🩸🩸 ░░░░░░░░░░░░░░░░│ ← 3 blessures → total 5 = éliminé
     └──────────────────────────┘
```

Si total des 🩸 sous la cible ≥ ses ❤ → héros hors combat / monstre éliminé.

### Soins
Soigne X points = retirer des cartes blessure dont le total d'icônes 🩸 est **≤ X**. Une carte ne peut pas être partiellement soignée. Les cartes retirées vont à la défausse.

> Exemple : soin 3 → retirer 🩸🩸 + 🩸 (2+1) ✓ ou 🩸🩸🩸 (3) ✓, mais pas 🩸🩸 + 🩸🩸 (2+2 = 4 > 3) ✗
...
- **Capacité spéciale** : 1×/combat. Tourner la carte à 90° quand utilisée. Certains effets la régénèrent.

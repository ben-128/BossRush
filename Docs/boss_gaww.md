...
```
Square format, wide shot showing full creature and environment. A massive shapeless spirit floating above the ground. A giant cloud of black smoke and shadow. Inside the mass, dozens of human faces appear and disappear — open mouths, wide eyes. Human arms emerge and retract from the smoke. No feet, only trailing smoke. A crown of floating white eyes around its head area. A black crystal corruption heart pulsing visible at the center of the mass.
...
Style: thick impasto oil painting with visible palette knife strokes and paint texture, but NOT impressionism. Keep forms solid and readable. Chunky paint application with visible ridges but maintain clear shapes and defined silhouette. Colors are rich and saturated, not broken into dots or dabs: deep charcoal black, dark purple, ghostly pale white, sulfur yellow, dried blood red, dusty cream. The texture is in the surface of the paint, not in dissolving the image. Think thick paint on a solid drawing. The smoke spirit must be painted with thick rough strokes, the faces visible but rough. No smooth digital rendering. No photorealism, but no abstract impressionist blur.

The creature takes up about 70% of the frame, the full mass visible, environment clearly visible around it.
```
